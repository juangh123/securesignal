# SecureSignal ???? ? ???????Storyboard?

> **?????2026-08-03?**
> - ? 6 ??? AI ??????`video/raw/voice_1.mp3 ? voice_6.mp3`?edge-tts?Andrew Neural?-8% ???
> - ? ??????????????`video/subs/voice_1.srt ? voice_6.srt` + ??? `video/subs/combined.srt`?49 ??
> - ? 6 ?????????`video/raw/seg1_title ? seg6_outro`?Playwright + Chrome ?? 1080p30?
> - ? **?????`video/dist/SecureSignal_demo_1080p.mp4`?2:22?H.264+AAC?-16 LUFS??100MB?**
> - ? ????? 2 ???????? 4 ????????? 5 ??????????**?? UI ??**????? e2e ??????
>   ????????? 3 ????? `video/raw/`??? `python video/scripts/assemble.py` ??????? `video/README.md`??
>
> ---
